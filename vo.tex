...
Listing~\ref{lst:adqlsample} shows an ADQL sample query: a crossmatch between a user-uploaded catalog (\texttt{TAP_UPLOAD.T1}), and
the The Third US Naval Observatory CCD Astrograph Catalog (UCAC3) % UCAC
