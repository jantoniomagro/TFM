...
\subsection{MapReduce in MongoDB} % (fold)
...
% section mapreduce_in_mongodb (end)
% subsection mapreduce_in_mongodb (end)
...
% 
% \lstinputlisting[language=SQL]{/home/jose/Escritorio/TFM/src/TapSchemaDAO.java}% section rewriting_the_alma_science_archive_with_nosql (end)
