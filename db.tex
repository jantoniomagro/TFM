...
We present now a logical layout using MongoDB features to solve the previously posed problem. For the sake of simplicity and clarity, we have not included all FITS keywords. \newline
